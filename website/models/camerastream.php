...
<div class="container">
<div class="text-dark bg-dark"><button class="btn-outline-light" id="startrecord"><img src="../images/resources/record2.png" height="60px" width="60px" center></img></button></div>
</div>
