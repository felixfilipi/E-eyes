...
<div class="container">
  <div class="mt-5"><img src=techbg.jpg width=100% height=450px></img></div>
  </div>

<div class="container">
<div class="text-dark bg-light"><button class="btn-outline-light" id="startrecord" onclick="startrecord()"><img src=record.png height="60px" width="60px" center></img></button></div>
</div>
